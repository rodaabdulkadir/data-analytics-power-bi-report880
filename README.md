...
1. **Download Power BI Desktop**: If you don't have it already, download and install [Power BI Desktop](https://powerbi.microsoft.com/en-us/downloads/) or if you have a Mac/Linux, use a virtual machine via the Microsoft Azure website.For more information about Microsoft Azure and its services, visit [Microsoft Azure](https://azure.microsoft.com/en-gb/free/search/?ef_id=_k_EAIaIQobChMI9o6V44zNhAMVU5VQBh14YgKcEAAYASAAEgITUvD_BwE_k_&OCID=AIDcmm3bvqzxp1_SEM__k_EAIaIQobChMI9o6V44zNhAMVU5VQBh14YgKcEAAYASAAEgITUvD_BwE_k_&gad_source=1&gclid=EAIaIQobChMI9o6V44zNhAMVU5VQBh14YgKcEAAYASAAEgITUvD_B)

3. **Clone or Download the Repository**: Clone or download this repository to your local machine.
